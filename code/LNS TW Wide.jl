...
function LNS_TWW(
    ...
    while time() - start_time < time_limit
        ...
        # Step 1: Apply the Worst Removal Wide TW destruction
...
for i in 1:4
    ...
    best_solution, _ = LNS_TWW(init_sol, t_limit, init_T, cooling_rate, n02, d02, t02, h02, ei02, li02, q02, perc, wd, wt, wv)
