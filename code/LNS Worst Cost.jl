...
function LNS_WC(
    ...
    while time() - start_time < time_limit
        ...
        # Step 1: Apply the worst cost destruction
        remaining_solution, removed_nodes = Worst_Cost_Removal(current_solution, percentage_to_destroy, d, t, h, ei, li, 3)
        ...
        if new_cost_2swap < best_cost
            ...
            println("Iteration: #", iterations, " --> New best solution found with cost: ", best_cost, " the solution is: ", best_solution, " the distance is: ", new_distance_2swap, " the traveled time is: ", new_time_2swap)
...
for i in 1:4
    ...
    best_solution, _ = LNS_WC(init_sol, t_limit, init_T, cooling_rate, n02, d02, t02, h02, ei02, li02, q02, perc, wd, wt, wv)
    ...
    # Print metrics
    println("Metrics for LNS Algorithm for i = : ", i)
